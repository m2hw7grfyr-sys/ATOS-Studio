...
class StudioVideoProject(Base):
    ...
    editorial_json_snapshot: Mapped[str] = mapped_column(Text, default="")
    editorial_parse_error: Mapped[str] = mapped_column(String(1000), default="")
...
class StudioGenerationTask(Base):
    ...
    current_step: Mapped[str] = mapped_column(String(80), default="", index=True)
    failed_step: Mapped[str] = mapped_column(String(80), default="", index=True)
    priority: Mapped[str] = mapped_column(String(40), default="normal", index=True)
